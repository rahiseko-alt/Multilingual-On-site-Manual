...
Extracts individual characters (e.g. Gojo, Hanami) from manga panels,
generates transparent PNGs, clean plate background, and animation manifests.
"""
import os
import uuid
import shutil
