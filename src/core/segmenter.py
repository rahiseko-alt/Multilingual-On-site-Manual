"""
Segmentation engine supporting SAM (Segment Anything), Rembg, and OpenCV intelligent fallbacks.
"""
...
class BaseSegmenter(ABC):
    ...
    def segment(
        ...
        """
        Generate binary mask (2D numpy uint8 array with 0 and 255).
        """
        pass
...
class SAMSegmenter(BaseSegmenter):
    """
    SAM (Segment Anything Model) wrapper with automatic smart fallback.
    """
    ...
    def segment(
        ...
        # Smart fallback: GrabCut or Box/Point based segmentation
    ...
    def _smart_fallback_segment(
        ...
        if box is not None:
            ...
            # Rough surrounding region as PR_FGD
...
def create_transparent_png(
    ...
    """
    Apply binary mask as alpha channel to image and return RGBA PIL Image.
    """
