"""
Inpainting module for generating Clean Plate backgrounds after character extraction.
"""
...
def generate_clean_plate(
    ...
    """
    Remove extracted characters from background by inpainting the masked area.
    """
